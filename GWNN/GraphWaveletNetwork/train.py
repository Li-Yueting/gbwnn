...
flags.DEFINE_float('wavelet_s', 1, 'wavelet s .')
flags.DEFINE_float('threshold', 1e-6, 'sparseness threshold .')
...
flags.DEFINE_integer('early_stopping', 50, 'Tolerance for early stopping (# of epochs).') #200
